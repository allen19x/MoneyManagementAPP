...
const MESSAGE_FONT = Fonts.SF_REGULAR
const MESSAGE_ACTION_FONT = Fonts.SF_BOLD

const PRIMARY_BUTTON_COLOR = Colors.BLUE_LIGHT
const PRIMARY_BUTTON_RIPPLE_COLOR = Colors.GRAY
const TOAST_DEFAULT_BACKGROUND_COLOR = Colors.BLACK
